<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register_.aspx.cs" Inherits="FullMart.Register" %>
...
<body>
    ...
    <div id="reguser" class="freg block center b">
        ...
        <table>
            <tr>
                ...
                <td>
                    <input class="validate[required] text-input" type="text" name="ufullname" id="ufullname" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input class="validate[required]" type="text" name="uusername" id="uusername" />
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <input class="validate[required]" type="password" name="upass" id="upass" />
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <input class="validate[required,funcCall[ckcap]]" type="text" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    ...
                    <button type="button" value="Sign up" onclick="CreateUser()">Sign up</button>               
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#unote").click(function () {
                showdialog($("#viewnote").html(), 700, 350, "#viewnote", false);
