            ...
            <ContentTemplate>
                <div id="tabs1P-3">
                    ...
                    <div class="insstate">
                        ...
                        <asp:TextBox ID="txtusrole" Visible=false runat="server"></asp:TextBox>
                        <asp:TextBox ID="txtusID" Visible=false runat="server"></asp:TextBox>
                    </div>
                                ...
                                <asp:SqlDataSource ID="dsManagingProductList" runat="server" ConnectionString="<%$ ConnectionStrings:FullMartConnectionString %>"
                                    ...
                                    <SelectParameters>
                                        ...
                                        <asp:ControlParameter ControlID="dlSubCategories" ConvertEmptyStringToNull="true"
                                            Name="SubcatID" />
                                        <asp:ControlParameter ControlID="txtusID" ConvertEmptyStringToNull="true" Name="usID" />
