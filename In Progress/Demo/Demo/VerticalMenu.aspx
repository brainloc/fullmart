<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VerticalMenu.aspx.cs" Inherits="Demo.VerticalMenu" %>
            ...
            <div id="divContent">
                <div id="divLeft">
                    <div id="divCategories">
                        <ul id="Lmenu">
                            <asp:DataList Width="100%" ItemStyle-Width="100%" ID="dliCategory" runat="server"
                                ...
                                <ItemTemplate>
                                    <li><a href='?cat=<%# Eval("ID") %>'>
                                        ...
                                        <ul>
                                            ...
                                            <asp:DataList Width="100%" ItemStyle-Width="100%" ID="dliSubCategory" runat="server"
