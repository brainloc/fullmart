...
namespace MNews.Helpers
{
	public static class PagingExtensions
	{
		...
		public static string Pager(this HtmlHelper htmlHelper, string strPrint, int pageSize, int currentPage, int totalItemCount)
		{
            return Pager(htmlHelper, strPrint, pageSize, currentPage, totalItemCount, null, null);
		}
		...
		public static string Pager(this HtmlHelper htmlHelper, string strPrint, int pageSize, int currentPage, int totalItemCount, string actionName, RouteValueDictionary valuesDictionary)
		{
			...
			var pager = new Pager(htmlHelper.ViewContext, strPrint, pageSize, currentPage, totalItemCount, valuesDictionary);
