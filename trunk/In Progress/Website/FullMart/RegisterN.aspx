...
<body>
                ...
                <div class="freg block center b shadow">
                    ...
                    <div id="regshop" class="block">
                        ...
                        <table>
                            <tr>
                                <td>
                                    Shop / Company Name<span style="color: red">*</span>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="validate[required,custom[email]" value="enter_your_mail@mail.com"
                                        type="text" name="semail" id="semail" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input class="validate[required,custom[email],funcCall[cksm]]" type="text" name="semailcf"
                                        id="semailcf" />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input class="validate[custom[url]]" value="http://" type="text" name="sweb" id="sweb" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p id='verys' class='very' title="reload image">
                                        ABjs</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input class="validate[required,funcCall[ckcaps]]" type="text" id="fregsckcap" name="fregsckcap" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                    ...
                    <div id="reguser" class="block">
                        <form id="freguser" runat="server" class="formular">
                        <table>
                            <tr>
                                <td>
                                    First Name<span style="color: red">*</span>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#freguser").find("button").click(function () {
