    ...
    <div class="TC" id="TC">
        ...
        <div class="acontent block">
            <p class="atitle block">
                Term Condition for Shop User</p>
            <span class="block">English version</span>
            <ckeditor:CKEditorControl ID="ShopEN" runat="server" Height="200" DefaultLanguage="En"></ckeditor:CKEditorControl>
            <%--<textarea class="block" id="ShopEN" cols="20" rows="2"></textarea>--%>
            <span class="block">Vietnamese version</span>
            <ckeditor:CKEditorControl ID="ShopVI" runat="server" Height="200" DefaultLanguage="Vi"></ckeditor:CKEditorControl>
            <%--<textarea class="block" id="ShopVI" cols="20" rows="2"></textarea>--%>
        </div>
        <div class="acontent block">
            <p class="atitle block">
                Footer</p>
