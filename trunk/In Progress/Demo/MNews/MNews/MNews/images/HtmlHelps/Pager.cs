...
namespace MNews.Helpers
{
	public class Pager
	{
        ...
        private string strPrint = "page";

        public Pager(ViewContext viewContext, string strPrint, int pageSize, int currentPage, int totalItemCount, RouteValueDictionary valuesDictionary)
		{
		...
		private string GeneratePageLink(string linkText, int pageNumber)
		{
			...
			pageLinkValueDictionary.Add(strPrint, pageNumber);
